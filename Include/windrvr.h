/* 
 * D r i v e r B u i l d e r    v 5 . 0 2
 * ==============================
 *
 * Header file for Windows 95/98/ME/NT/NTE/NT2000/CE/Linux/Solaris/VxWorks.
 * FOR DETAILS ON THE DriverBuilder FUNCTIONS, PLEASE SEE THE DriverBuilder MANUAL
 * OR INCLUDED HELP FILES.
 *
 * This file may not be distributed -- it may only be used for development
 * or evaluation purposes. (see \DriverBuilder\docs\license.txt for details).
 *
...
// compiler flags (from the makefile or the Tornado IDE) to compile DriverBuilder
// related source code.
#define WD_VER      502
...
#define WD_VER_STR  WD_PROD_NAME  " V5.02 Jungo (c)2001 Build Date: " __DATE__ WD_CPU_SPEC WD_FILE_FORMAT
...
// DriverBuilder function IOCTL calls.  For details on the DriverBuilder functions,
// see the DriverBuilder manual or included help files.
