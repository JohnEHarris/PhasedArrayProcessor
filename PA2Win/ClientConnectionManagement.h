...
class CClientSocket;
extern CClientConnectionManagement *pCCM[];	// global, static ptrs to class instances defined outside of the class definition.
...
public:
	...
	void SetSocketPtr(CClientSocket* pSkt)	{	if (m_pstCCM)	m_pstCCM->pSocket = (CClientSocket *) pSkt;			}
