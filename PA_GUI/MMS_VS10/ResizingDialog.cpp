...
#define RESIZE_TIMER 1333
BOOL CResizingDialog::m_bResizeDlg = TRUE;
...
void CResizingDialog::OnSize(UINT nType, int cx, int cy) 
{
	...
	if(m_old_cx)
	{
		...
		for(int i = 0; i < m_control_info.GetSize(); i++)
		{
			...
			SetTimer(RESIZE_TIMER, 200, NULL);
		}
...
//
// copy function prototype from Dummy.cpp, rename class
// jeh 21-May-12
LRESULT CResizingDialog::OnNcHitTest(CPoint point)
//INT CResizingDialog::OnNcHitTest(CPoint point)
{
...
void CResizingDialog::OnTimer(UINT nIDEvent) 
{
	// TODO: Add your message handler code here and/or call default
	if (nIDEvent == RESIZE_TIMER)
	{
