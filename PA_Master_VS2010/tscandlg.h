...
//	void BuildTholdMsg (C_MSG_19 *pMsg);
	...
	BOOL SendMsgToPAM(int nClientNumber, int nMsgID, void *pMsg);
	BYTE* BuildPAM_Message(int nClientNumber, int nMsg, int *pnLength, void *pv); // not used
...
public:
	afx_msg void OnConfigurationNcNxPhasedArray();
};
